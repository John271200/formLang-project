...
**Dépôt Git :** https://github.com/John271200/formLang-project   ·   **Commit final :** `4882186`
...
| Volet | AGBESSI John Ulrich | LATOOUNDJI Gregoire |
|-------|---------------------|---------------------|
| Jour 1 (dfa/nfa/fst + detector) | *à compléter* | *à compléter* |
| Jour 2 (pda/cfg) | *à compléter* | *à compléter* |
| Jour 3 (tree/morpho/shield/hashcons) | *à compléter* | *à compléter* |
| Jour 4 (turing/utm/mtu) | *à compléter* | *à compléter* |
| Jour 5 (pipeline/nerode) + rapport | *à compléter* | *à compléter* |
